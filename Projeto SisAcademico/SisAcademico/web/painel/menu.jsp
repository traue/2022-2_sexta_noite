                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<%=request.getContextPath()%>/painel/relatorios/loader.jsp?pagina=aluno"">Alunos</a></li>
                                <li><a class="dropdown-item" href="<%=request.getContextPath()%>/painel/relatorios/loader.jsp?pagina=curso">Cursos</a></li>
                            </ul>
                        </li>
                    </ul>
                    <span class="navbar-text">
                        <a class="nav-link active" href="../LoginController?signOut">Sair</a>
                    </span>
                </div>
            </div>
        </nav>

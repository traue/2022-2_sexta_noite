...
import br.siscademico.util.AcaoDAO;
...
public class CursoController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            switch (acao) {
                case leitura:
                    Map<Curso, Integer> cursosMap
                            = cursoDAO.getCursosCountaAlunos();
                    session.setAttribute("listaDeCursos", cursosMap);
                    response.sendRedirect(request.getContextPath() + "/painel/relatorios/curso.jsp");
                    break;
                default:
                    break;
            }
